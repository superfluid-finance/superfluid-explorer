...
Then(`Incoming streams filtered by senders address are shown correctly for {string}`, (network) => {
...
Then(`Outgoing streams filtered by receivers address are shown correctly for {string}`, (network) => {
...
Then(`Events filtered by event name are shown correctly for {string}`, (network) => {
