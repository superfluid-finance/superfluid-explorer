...
Given(
  `The token address, symbol , underlying address , network and listing is shown correctly for {string}`,
  (network) => {
...
Then(
  `Streams filtered by senders address are shown correctly for {string}`,
  (network) => {
...
Then(
  `Streams filtered by receivers address are shown correctly for {string}`,
  (network) => {
...
Then(
  `Indexes filtered by publishers address are shown correctly for {string}`,
  (network) => {
