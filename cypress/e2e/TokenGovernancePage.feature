Feature: Token page test cases
  ...
  Scenario: Data displayed in network governance tokens page
    ...
    And User switches network for "mumbai" and validates data
    Then User filters super tokens by name for "mumbai"
    Then User filters super tokens by symbol for "mumbai"
