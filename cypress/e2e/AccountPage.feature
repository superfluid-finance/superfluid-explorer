Feature: Account page test cases
  ...
  Scenario: Filtering incoming stream cases for streams tab
    Given User has opened the "balance account for filtering" page on "mumbai"
    And User switches to "streams" tab
    Then  User filters incoming streams by senders address for "mumbai"
    Then Incoming streams filtered by senders address are shown correctly for "mumbai"
  ...
  Scenario: Filtering outgoing stream cases for streams tab
    Given User has opened the "balance account for filtering" page on "mumbai"
    And User switches to "streams" tab
    And User filters outgoing streams by receivers address for "mumbai"
    Then Outgoing streams filtered by receivers address are shown correctly for "mumbai"
  ...
  Scenario: Filtering cases for super tokens tab
    Given User has opened the "second balance account for filtering" page on "mumbai"
